...
from wb_bidder.core.auth import load_token, load_api_base_url
...
class ApiClientV2:
    ...
    def get_campaigns(self, params: Optional[Mapping[str, Any]] = None) -> Any:
        """
        Получить список рекламных кампаний из backend_v2.

        Args:
            params: Параметры запроса (type, status и т.д.)
